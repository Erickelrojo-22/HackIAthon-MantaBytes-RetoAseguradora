...
def main() -> None:
    ...
    page = sidebar()
    if page == "Demo guiada":
        page_demo_guiada(table, DEFAULT_DB_PATH)
    elif page == "Resumen":
        page_resumen(table, DEFAULT_DB_PATH)
    elif page == "Bandeja de revision":
        page_bandeja(table)
    elif page == "Detalle del siniestro":
        page_detalle(table, DEFAULT_DB_PATH)
    elif page == "Evaluar caso nuevo":
        page_case_form()
    elif page == "Red de relaciones":
        page_network(DEFAULT_DB_PATH)
    elif page == "Agente IA":
        page_agent(DEFAULT_DB_PATH)
    elif page == "Reporte ejecutivo":
        page_report(DEFAULT_DB_PATH)
